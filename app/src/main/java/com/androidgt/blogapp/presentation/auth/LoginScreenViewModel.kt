package com.androidgt.blogapp.presentation.auth

import androidx.lifecycle.ViewModel
import androidx.lifecycle.ViewModelProvider
import androidx.lifecycle.liveData
import com.androidgt.blogapp.core.Resource
import com.androidgt.blogapp.domain.auth.LoginRepo
import kotlinx.coroutines.Dispatchers

class LoginScreenViewModel(private val repo: LoginRepo) : ViewModel() {

    fun sigIn(email: String, password: String) = liveData(Dispatchers.IO) {
